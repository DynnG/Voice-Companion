...
import { Plus, MessageCircle, Clock, ChevronLeft, X, FileText } from 'lucide-react';
    ...
    <div className="h-full flex flex-col bg-[#133020] text-[#f5eedb] border-r border-[#046241]/30">
      ...
      <div className="flex-1 overflow-y-auto px-3 py-2 space-y-5">
        {conversations.length === 0 ? (
          <div className="p-4 text-center text-xs text-[#f5eedb]/60">
            No interview history yet. Click &quot;New Interview&quot; to begin.
          </div>
        ) : (
